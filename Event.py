...
class Event:
   def __init__(self, email_id, event_date, fk_event_type_id, fk_campaign_name):
   ...
   def __str__(self):
      return   str(self.email_id) + ', "' + str(self.event_date) + '", ' + str(self.fk_event_type_id) + ', ' + str(self.fk_campaign_name)
