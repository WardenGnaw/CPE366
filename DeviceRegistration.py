...
class DeviceRegistration:
   def __init__(self, registration_id, registration_date, fk_device_model, fk_purchase_store_id, fk_serial_number, fk_registration_source_id, fk_purchase_date):
   ...
   def __str__(self):
      return str(self.registration_id) + ', "' + str(self.registration_date) + '", ' + str(self.fk_device_model) + ', ' + str(self.fk_purchase_store_id) + ', ' + str(self.fk_serial_number) + ', ' + str(self.fk_registration_source_id) + ', ' + str(self.fk_purchase_date)
